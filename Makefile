...
LIBS = -lbgen -lzstd -ldb  -lsqlite3 -lboost -lz -lboost_program_options 
INC += -I${PGEN_PATH} -I${PGEN_PATH}/include/ -I${BGEN_PATH} -I${BGEN_PATH}/genfile/include/ -I${BGEN_PATH}/3rd_party/zstd-1.1.0/lib
